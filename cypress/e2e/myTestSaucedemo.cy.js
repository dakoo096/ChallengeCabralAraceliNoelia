...
describe(
  ...
  () => {
    ...
    it("Comprobar en carrito que todos los productos se puedan eliminar correctamente", () => {
      ...
      cy.elimitaryVerificarCarrito();
    });

    it("corroborar link twitter", () => {
      cy.get('[data-test="social-twitter"]').should(
        "have.attr",
        "href",
        "https://twitter.com/saucelabs"
      ); //corroboramos que el enlace vaya a la ruta especificada sin necesidad de salir de la pag
    });

    it("corroborar link facebook", () => {
      cy.get('[data-test="social-facebook"]').should(
        "have.attr",
        "href",
    ...
    it("corroborar link linkedIn", () => {
      cy.get('[data-test="social-linkedin"]').should(
        "have.attr",
        "href",
...
describe(
  "Test Challenge con usuario 2,pruebas adicionales",
  { testIsolation: false },
  () => {
    it("Iniciar sesion", () => {
      cy.Login("problem_user", "secret_sauce");
